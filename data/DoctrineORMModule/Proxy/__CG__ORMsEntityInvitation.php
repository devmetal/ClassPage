 ...
 */
class Invitation extends \ORMs\Entity\Invitation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'email', 'code', 'edited', 'created', 'used', 'creator', 'user');
        }
     ...
     * {@inheritDoc}
     */
    public function assignToUser(\ORMs\Entity\User $u)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'assignToUser', array($u));

        return parent::assignToUser($u);
    }
